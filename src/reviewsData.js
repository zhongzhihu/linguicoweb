export const reviewsData = [
  {
    title: "Easy to use",
    text: "This app strips away all the complexity of the German language and keeps things refreshingly simple. Nice grammar summaries and clear bite-sized grammar lessons that just take 5-10 minutes each.",
    username: "mablic",
    date: "Oct 25, 2024",
    rating: 5,
  ...
  {
    title: "Fantastisch!",
    text: "Ideal if you want to increase your German vocabulary. You get to learn at your own pace: the app uses spaced repetition so that you can quickly learn and retain all the words you learn. There are also lessons and quizzes to help you improve your German grammar and even a built in German-English / English-German dictionary! Highly recommended 👍",
    username: "Zenopolis",
    date: "Oct 20, 2024",
    rating: 5,
    country: "United Kingdom",
